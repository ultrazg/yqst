                    ...
                    >
                        ...
                        <p>
                            <Input
                                ...
                                onChange={e => this.setState({refuseReason: e.target.value})}
                            />
                        </p>

                        <Button
                            danger
                            disabled={!this.state.refuseReason}
                            onClick={() => {
                                const {sn, refuseReason} = this.state;

                                CostAssistantModel.CostAsstPlayerRefuse({
                                    sn,
                                    refuseReason
                                }, res => {
                                    this.getList();
                ...
                }
                {
                    ...
                    >
                        ...
                        <Button type='primary' onClick={() => {
                            ...
                            CostAssistantModel.CostAsstPlayerConfirm({sn}, res => {
                                this.getList();
                                this.setState({
                                    submitModal: false
                                });
