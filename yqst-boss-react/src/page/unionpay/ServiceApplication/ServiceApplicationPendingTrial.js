...
class ServiceApplicationPendingTrials extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: {
            ...
            },
            {
                ...
                render: (a, b, c) => {
                    return <Button size='small' type='primary'
                                   onClick={() => {
                                       return this.props.history.push(`/Pages/ServiceApplicationPendingTrialDetail?id=${b.appealId}`)
                                   }}>操作</Button>
                }
            }]
        return (
...
const ServiceApplicationPendingTrial = ServiceApplicationPendingTrials
export default ServiceApplicationPendingTrial
