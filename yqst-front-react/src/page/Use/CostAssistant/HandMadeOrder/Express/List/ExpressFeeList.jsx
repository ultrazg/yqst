 ...
 * 租赁物流单列表
 */
class ExpressFeeList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
            ...
            },
            {
                ...
                render: record => {
                    return <Button type='link' onClick={()=>{
                        this.props.history.push('/pages/appCenter/costAssistant/costAssistantHome/ExpressFeeDetail?sn=' + record.sn);
                    }}>详情</Button>
                }
            }
        ]
        ...
        return (
            <>
                ...
                <Button type='primary' onClick={() => {
                    this.props.history.push('/pages/appCenter/costAssistant/costAssistantHome/ExpressFeeCreate');
                }}><PlusOutlined/>添加租赁物流费用</Button>
            </>
        )
    }
    ...
    getList = () => {
        CostAssistantModel.FeeExpressPayeePage(this.state.requestPar, res => {
            this.setState({
