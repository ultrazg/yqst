...
import carrierAsstMenu from './CarrierAsstMenu';
import CarrierAsstRouter from './CarrierAsstRouter';
import {LeftOutlined} from '@ant-design/icons'

const {SubMenu} = Menu;

class CarrierAsstHome extends Component {
    constructor(props) {
        super(props);
        this.state = {
            openKeys: [],
...
export default CarrierAsstHome;
