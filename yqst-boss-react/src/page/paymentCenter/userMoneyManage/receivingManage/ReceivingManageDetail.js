...
class ReceivingManageDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: {
            ...
            <Form ref={this.formRef}>
                <ViewContent
                    crumb={[
                        {name: '支付中心'},
                        {name: "用户资金管理"},
                        {name: "收付款管理列表", link: '/Pages/ReceivingManageList'},
                        {name: "收付款管理详情"}
                    ]}
                    topBtn = {
                        <div>
                            {/*<Button type="primary" icon={'edit'}>编辑</Button>*/}
                            <Link to={'/Pages/ReceivingManageList'} style={{marginLeft: 15}}>
    ...
    getInfo() {
        Model.walletPRGet({receiveId: this.id}, (res) => {
    ...
    getLogList() {
        Model.walletPCLList({id: this.id, type: 1}, (res) => {
        ...
        let allData = [
            {
                ...
                data: [
                    ...
                    {key: 'accountMoney', type: 'Texts', label: '款项金额', span: 12,
                        value: NumberFormat.thousandBit(data.accountMoney || 0, 2, true)},
                    {key: 'billType', type: 'Texts', label: '来源单据', span: 12, value: SwitchName.billTypeName(data.billType)},
                    {key: 'billSn', type: 'Texts', label: '来源单号', span: 12, value: data.billSn},
            ...
            },
            {
                ...
                key: 'ZFKey',
                data: [
                    {key: 'payType', type: 'Texts', label: '支付类型', span: 12, value: SwitchName.payTypeName(data.payType)},
                    ...
                    {
                        key: 'vouchers', type: 'UploadFile', label: '付款凭证', span: 12,
...
export default ReceivingManageDetail
