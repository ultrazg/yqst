...
import SupplementAsstMenu from "./SupplementAsstMenu";
import SupplementAsstRouter from "./SupplementAsstRouter";

const {SubMenu} = Menu;

class SupplementAsstHome extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            openKeys: [],
    ...
    componentDidMount() {
        this.setState({
            openKeys: this.getOpenKeys(this.props.history.location.pathname.split('/')[3] ? this.props.history.location.pathname.split('/')[3] : ''),
        });
    }
    ...
    arrangeKeys() {
        ...
        openKeysFun(SupplementAsstMenu());
    ...
    makeLeft() {
        ...
        selectedKeys = this.props.history.location.pathname.split('/')[3] ? [this.props.history.location.pathname.split('/')[3]] : [];
        const menuView = (list = []) => {
    ...
    makeRight() {
        ...
        >
            <SupplementAsstRouter/>
        </div>
    }

}

export default SupplementAsstHome;