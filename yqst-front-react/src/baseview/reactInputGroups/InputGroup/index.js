                        ...
                        <div onClick={this.inputFocus} className="box-root-container">
                            ...
                            <div className="box-containers">
                                {boxLength.map((item, index) => {
                                    return (
                                        <div style={item === numList.length && isFocus ? {
                                            borderBottomWidth: 2,
                                            borderColor: '#1f90e6'
                                        } : {}}
                                             key={index}>
                                            {numList[item] ? (this.props.hide ? '●' : numList[item]) : ''}
                                            <span
                                                className="shake"
                                                style={{
                                                    color: '#1f90e6',
                                                    display: item === numList.length && isFocus ? 'block' : 'none'
                                                }}>|</span>
                                        </div>
                                    )
                                })}
                        ...
                        <div onClick={this.inputFocus} className="box-root-container">
                            ...
                            <div className="box-container">
                                {boxLength.map((item, index) => {
                                    return (
                                        <div
                                            style={item === numList.length && isFocus ? {
                                                borderWidth: 2,
                                                borderColor: '#1f90e6'
                                            } : {}} key={index}>
                                            {numList[item] ? (this.props.hide ? '●' : numList[item]) : ''}
