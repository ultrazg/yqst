...
class InitiateList extends Component {
            ...
            },
            {
                ...
                render: (res, record) => {
                    return <Button
                        type="link"
                        onClick={() => {
                            this.props.history.push('/pages/appCenter/InitializationTool/MaterialRecListModule/LesseeInitDetail?sn=' + record.sn);
                        }}
                    >详情</Button>
                }
            },
    ...
    getList = () => {
        Model.LesseeInitPage(this.state.requestPar, res => {
            this.setState({
