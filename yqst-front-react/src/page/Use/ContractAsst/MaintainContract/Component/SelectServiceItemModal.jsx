...
class SelectServiceItemModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            list: [],
    ...
    getList = () => {
        request(Api.MaintainLessorSelectServiceItem, this.state.requestPar, res => {
...
export default SelectServiceItemModal;
