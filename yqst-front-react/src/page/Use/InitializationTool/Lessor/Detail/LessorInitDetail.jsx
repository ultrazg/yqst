...
class LessorInitDetail extends Component {
        ...
        return (
            <>
                ...
                <div style={{padding: "24px", borderRadius: "6px", marginTop: "24px", background: "#fff"}}>
                    ...
                    {/*在租物资弹窗start*/}
                    {
                        this.state.isSelectGoodsModalVisible2
                            ? <SelectLeaseGoodsModal
                                onSelect={data => {
    ...
    renderUpdateBtn = () => {
        // showUpdateButton  显示更新按钮 0.否 1.出租修改（//出租方发起,出租修改提交接口） 2.承租修改（//承租方发起,承租修改提交接口）
    ...
    getList = () => {
        ...
        Model.InitDetailGet({
            ...
            this.setState({
                ...
                // LeaseList: this.makeLeaseList(res.data.startingGoodsList),
    ...
    onInitUpdate = () => {
        ...
        Model.LessorInitUpdate({
            sn,
            settlementStartTime: startTime,
            remark,
            startingGoodsList: newLeaseList,
            // leasingGoodsList,
            isSubmit: 1,
