 ...
 * 承租方合同列表
 */
class LesseeContractList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
            ...
            },
            {
                ...
                render: (text, record) => {
                    return <a style={{fontSize: 14}}
                              onClick={() => this.props.history.push('/pages/appCenter/contractAsst/contractAsstHome/contractInfoMaintain/detail?sn=' + record.sn)}>查看</a>
                }
            },
        ];
    }
    ...
    getList = () => {
        request(Api.LesseeContractPage, this.state.requestPar, res => {
            this.setState({
...
export default LesseeContractList;
