...
import SelectLessorProjectModal from "./SelectLessorProjectModal";
 ...
 * 租赁价格&结算信息
 */
class Step1Lessee extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isSelectLessorModalVisible: false,
            isSelectLessorProjectVisible: false,
    ...
    getSettleTime = () => {
        request(Api.ContractPriceAddSettleTime, {
            lessorSn: this.props.data.lessorSn || '',//	string	是	承租方企业用户编号
        ...
        return (
            <>
                ...
                <div style={{
                    ...
                    <label style={{width: 150}}>出租方：</label>
                    <Input
                        style={{width: 300, cursor: 'pointer'}}
                        placeholder="请选择出租企业"
                        title={this.props.data.lessorName}
                        value={this.props.data.lessorName}
                        readOnly
                        onClick={() => {
                            this.setState({
                                isSelectLessorModalVisible: true
                            });
                        }}
                    />
                </div>
                ...
                <div style={{
                    ...
                    {this.props.data.projectType == 0 ?
                        ...
                        <Input
                            style={{width: 300, cursor: 'pointer'}}
                            placeholder={!this.props.data.lessorSn ? '请先选择出租企业' : '选择项目'}
                            disabled={!this.props.data.lessorSn}
                            title={this.props.data.projectName}
                            value={this.props.data.projectName}
                            readOnly
                            onClick={() => {
                                this.setState({
                                    isSelectLessorProjectVisible: true
                                })
                            }}
                        />}
                </div>
                ...
                {/*选择承租方弹窗*/}
                {
                    this.state.isSelectLessorModalVisible
                        ? <SelectLessorModal
                            onClose={() => {
                                this.setState({
                                    isSelectLessorModalVisible: false
                ...
                {/*选择项目弹窗*/}
                {
                    this.state.isSelectLessorProjectVisible
                        ? <SelectLessorProjectModal
