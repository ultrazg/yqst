 ...
 * 查看费用单modal
 */
class FeeListModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    getList = () => {
        CostAssistantModel.CostAsstGetSettlementFeeList({...this.state.requestPar, listType: 1}, res => {
            this.setState({
...
class List extends React.Component {
    ...
    getList = () => {
        ...
        CostAssistantModel.CostAsstGetSettlementFeeList({...requestPar, listType}, res => {
            this.setState({
                total: res.data.total || 0,
                data: res.data.records || []
            });
