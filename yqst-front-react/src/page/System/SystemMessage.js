...
import {allTypeNews, allNewsTotal} from "../layout/redux/mainLayoutAction";
...
class SystemMessage extends Component {
    ...
    getNewsModelIPage(id) {
        let {current, pageSize, allTypeList} = this.state;
                        ...
                        allTypeList && allTypeList.map((item, idx) => {
                            return <li
                                ...
                                onClick={() => {
                                    ...
                                    this.setState({allTypeList, changeRow}, () => {
                                                    ...
                                                    <Popconfirm
                                                        ...
                                                        onConfirm={() => {
                                                            Model.NewsModelIHide({id: item.id}, (res) => {
                                                                ...
                                                                this.getNewsModelIPage(this.state.changeRow.id);
                                                            })
                                                        }}
                                                        onCancel={() => {
                                                        }}
