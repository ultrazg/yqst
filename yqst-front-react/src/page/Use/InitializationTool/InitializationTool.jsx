...
import InitializationToolMenu from "./InitializationToolMenu";
import InitializationToolRouter from "./InitializationToolRouter";

const {SubMenu} = Menu;

class InitializationTool extends Component {
    constructor(props) {
        super(props);
        this.state = {
            openKeys: [],
    ...
    arrangeKeys() {
        ...
        openKeysFun(InitializationToolMenu());
        ...
        return (
            ...
            >
                ...
                <Menu
                    ...
                    // style={{ width: 256 }}
                >
                    {menuView(InitializationToolMenu())}
                </Menu>
            </div>
        );
    }
