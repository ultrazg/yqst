...
import Model from '../../MaterialCenterModel';

class ConvertUnitSelectModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            list: [],
    ...
    getList() {
        Model.MaterialsCenterConvertUntitSelect({...this.state.requestPar, sn: this.props.sn || ''}, res => {
...
export default ConvertUnitSelectModal;
