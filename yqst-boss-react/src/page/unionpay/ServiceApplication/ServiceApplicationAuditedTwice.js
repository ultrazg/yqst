...
class ServiceApplicationAuditedTwices extends Component {
    constructor(props){
        super(props)
        this.state={
            data:{
            ...
            },
            {
                ...
                render: (a, b, c) => {
                    return <Button size='small' type='primary'
                                   onClick={() => {
                                       return this.props.history.push(`/Pages/ServiceApplicationAuditedTwiceDetail?id=${b.appealId}`)
                                   }}>操作</Button>
                }
            }]
        return (
...
const ServiceApplicationAuditedTwice = ServiceApplicationAuditedTwices
export default ServiceApplicationAuditedTwice
