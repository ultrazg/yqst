...
import CertificateCenterMenu from './CertificateCenterMenu';
import CertificateCenterRouter from './CertificateCenterRouter';
import {LeftOutlined} from '@ant-design/icons'

const {SubMenu} = Menu;

class certificateCenterHome extends Component {
    constructor(props) {
        super(props);
        this.state = {
            openKeys: [],
    ...
    arrangeKeys() {
        ...
        openKeysFun(CertificateCenterMenu());
        ...
        return (
            ...
            >
                ...
                <Menu
                    ...
                    // style={{ width: 256 }}
                >
                    {menuView(CertificateCenterMenu())}
                </Menu>
            </div>
        );
    }
    ...
    makeRight() {
        ...
        >
            <CertificateCenterRouter/>
        </div>
    }
}

export default certificateCenterHome;
