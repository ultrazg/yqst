...
class ExitDetailModal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isShowBtn: this.props.isShowBtn,
            leaseExitSn: this.props.leaseExitSn || '',
            data: {}
        };
    }
        ...
        return (
            <div>
                ...
                >
                    ...
                    <Descriptions title="退场单详情">
                        <Descriptions.Item
                            label="退场单号">{this.state.data.leaseExitSn ? this.state.data.leaseExitSn : ''}</Descriptions.Item>
                        <Descriptions.Item
                            label="退场时间">{this.state.data.exitTime ? this.state.data.exitTime : ''}</Descriptions.Item>
                        <Descriptions.Item
