 ...
 * @LastEditTime : 2021-05-26 16:24:21
 */
...
function CategorySelector({ value = {}, onChange, placeholder }) {
        ...
        >
            {
                categorylist && categorylist.map(
                    (item) => {
                        return (
                            <Option value={item.categorySn} key={item.categorySn}>
                                {item.categoryName}
                            </Option>
                        );
                    }
