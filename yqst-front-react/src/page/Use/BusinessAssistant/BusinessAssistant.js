...
import BAMenuData from './BAMenuData';
import BusinessAssistantRouter from './BusinessAssistantRouter';
import {LeftOutlined} from '@ant-design/icons';

const {SubMenu} = Menu;

class BusinessAssistant extends Component {
    constructor(props) {
        super(props);
        this.state = {
            openKeys: [],
