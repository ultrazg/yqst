 ...
 * 切割后物资
 */
class SelectLeaseCuttingAfterModal extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            requestPar: {
                ...
                pageSize: 5,
                keyWord: '',
                leaseGoodsSn: this.props.leaseGoodsSn || '',
            },
        }
    }
    ...
    getList() {
        request(Api.SelectCuttingLesseeAfterGoodsList, this.state.requestPar, res => {
            this.setState({
                list: res.data ? this.makeData([res.data]) : [],
...
export default SelectLeaseCuttingAfterModal;
