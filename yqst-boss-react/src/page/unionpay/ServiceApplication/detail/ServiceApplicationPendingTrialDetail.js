...
class ServiceApplicationPendingTrialDetails extends Component {
                    ...
                    >
                        {
                            appealDeal.isPass ?
                                <div>
                                    <FormItem {...formItemLayout} label="收单机构名">
                                        {getFieldDecorator('orgName', {initialValue: this.state.data.orgName || ''})(
                                            <Input placeholder='请输入'/>)}
                                    </FormItem>
                                    <FormItem {...formItemLayout} label="商户服务类别码(mcc)">
                                ...
                                </div> : <FormItem {...formItemLayout} label="审核驳回理由">
...
const ServiceApplicationPendingTrialDetail = Form.create()(ServiceApplicationPendingTrialDetails)
export default ServiceApplicationPendingTrialDetail
