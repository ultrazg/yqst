...
class ComCommodityLabelList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            list: [],
    ...
    render() {
        return (
            <TabsViewContent
                crumb={[{name: '商品中心'}, {name: "商品管理"}, {name: "商品标签列表"}]}
    ...
    getList() {
        Model.ShopGTPage(this.state.requestPar, (res) => {
    ...
    makeHeadSearch() {
        const searchDatas = [
            {key: 'keyWord', type: 'Input', value: '', placeholder: '可查询标签名称、所属销售终端', label: '关键字', maxLength: 30},
...
export default ComCommodityLabelList
