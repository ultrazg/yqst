...
class PaContractTemplateDetail extends Component {
	constructor(props) {
		super(props);
		this.state = {
			typeSnList: [],
	...
	render() {
		...
		return (
			<ViewCoat
				breadCrumb={[
					{title: '合同模板', link: '/pages/appCenter/purchasingAssistant/paIndex/PaContractTemplate/PaContractTemplateList'},
	...
	onSubmit(){
		...
		Model.ContractTSave(obj, (res) => {
			...
			this.props.history.push('/pages/appCenter/purchasingAssistant/paIndex/PaContractTemplate/PaContractTemplateList');
		});
	}
}

export default PaContractTemplateDetail;
