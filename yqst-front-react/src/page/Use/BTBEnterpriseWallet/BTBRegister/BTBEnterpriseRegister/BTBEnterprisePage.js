...
class BTBEnterprisePage extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
        ...
        return (
            <ViewCoat
                ...
                >
                    ...
                    <a
                        onClick={() => {
                            this.props.history.push('/pages/appCenter/btbEnterpriseWallet/btbRegister/btbEnterpriseRegister');
                        }}
                    >开通</a>
                </div>}
                // topView={<div>
...
export default BTBEnterprisePage;
