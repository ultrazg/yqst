 ...
 * 租赁维保单列表
 */
class ServiceFeeList extends Component {
    constructor(props) {
        super();
        this.state = {
            data: [],
            ...
            },
            {
                ...
                render: record => {
                    return <Button type='link' onClick={() => {
                        this.props.history.push('/pages/appCenter/costAssistant/costAssistantHome/ServiceFeeDetail?sn=' + record.sn);
                    }}>详情</Button>
                }
            }
        ]
        ...
        return (
            <>
                ...
                <Button type='primary' onClick={() => {
                    this.props.history.push('/pages/appCenter/costAssistant/costAssistantHome/ServiceFeeCreate');
                }}><PlusOutlined/>添加租赁维保费用</Button>
            </>
        )
    }
    ...
    getList = () => {
        CostAssistantModel.FeeServicePayeePage(this.state.requestPar, res => {
            this.setState({
