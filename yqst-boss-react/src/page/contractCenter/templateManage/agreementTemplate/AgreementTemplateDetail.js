...
class AgreementTemplateDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: {},
            ...
            <Form ref={this.formRef}>
                <ViewContent
                    crumb={[
                        {name: '合同中心'},
                        {name: "模板管理"},
                        {name: "协议模板列表", link: '/Pages/AgreementTemplateList'},
                        {name: "协议模板详情"}
                    ]}
                    topBtn = {
                        <div>
                            <Button type="primary" icon={<EditOutlined />}>编辑</Button>
                            <Link to={'/Pages/AgreementTemplateList'} style={{marginLeft: 15}}>
        ...
        let allData = [
            {
                ...
                key: 'JBKey',
                data: [
                    {key: 'qw1', type: 'Texts', label: '协议模版ID', span: 12, value: ''},
                    {key: 'qw2', type: 'Texts', label: '协议模版类型', span: 12, value: ''},
                    {key: 'qw3', type: 'Texts', label: '协议模版名称', span: 12, value: ''},
                    {key: 'qw4', type: 'Texts', label: '协议模版状态', span: 12, value: ''},
...
export default AgreementTemplateDetail
