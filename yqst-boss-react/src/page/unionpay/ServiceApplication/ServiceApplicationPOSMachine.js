...
class ServiceApplicationPOSMachines extends Component {
    constructor(props){
        super(props)
        this.state={
            data:{
            ...
            },
            {
                ...
                render: (a, b, c) => {
                    return <Button size='small' type='primary'
                                   onClick={() => {
                                       return this.props.history.push(`/Pages/ServiceApplicationPOSMachineDetail?id=${b.appealId}`)
                                   }}>操作</Button>
                }
            }]
        return (
...
const ServiceApplicationPOSMachine = ServiceApplicationPOSMachines
export default ServiceApplicationPOSMachine
