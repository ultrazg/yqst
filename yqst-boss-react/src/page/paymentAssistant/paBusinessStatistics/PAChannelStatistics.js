...
class PAChannelStatistics extends Component {
    ...
    render() {
        return (
            <TabsViewContent
                crumb={[{name: '收支付助手'}, {name: '业务统计'}, {name: '渠道统计'}]}
        ...
        return (
            <div>
                <div style={{height: 36, display: 'flex', alignItems: 'center', backgroundColor: '#e7f3fc'}}>
                    ...
                    <span style={{marginLeft: 10}}>充值接口：</span>
                    <span style={{color: '#ca0810'}}>0</span>
                    <span style={{marginLeft: 18}}>开户接口：</span>
                    <span style={{color: '#ca0810'}}>0</span>
                    <span style={{marginLeft: 18}}>转账接口：</span>
                    <span style={{color: '#ca0810'}}>0</span>
                    <span style={{marginLeft: 18}}>提现接口：</span>
                    <span style={{color: '#ca0810'}}>0</span>
                </div>
...
export default PAChannelStatistics;