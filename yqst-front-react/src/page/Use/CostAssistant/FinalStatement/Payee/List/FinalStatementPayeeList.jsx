...
class FinalStatementPayeeList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
            ...
            requestPar: {
                ...
                endTime: '',
                keyWord: '',
                status: 0, //["待提交", "待确认", "已结算", "已拒绝"] 1 3 4 5
            ...
            },
            {
                ...
                render: record => {
                    return <Button type='link' onClick={() => {
                        this.props.history.push('/pages/appCenter/costAssistant/costAssistantHome/FinalStatementPayee/FinalStatementPayeeDetail?sn=' + record.sn);
                    }}>详情</Button>
                }
            }
        ]
    ...
    getList = () => {
        CostAssistantModel.FinalStatementPayeeList(this.state.requestPar, res => {
            this.setState({
...
export default FinalStatementPayeeList;
