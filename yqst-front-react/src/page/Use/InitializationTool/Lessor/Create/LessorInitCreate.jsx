            ...
            <>
                ...
                <div style={{padding: "24px", borderRadius: "6px", marginTop: "24px", background: "#fff"}}>
                        ...
                        this.state.projectType === 1
                            ? <p style={{
                                ...
                                <Input
                                    ...
                                    placeholder={!this.state.lesseeSn ? '请先选择对账客户' : '请选择项目名称'}
                    ...
                    <p style={{
                        ...
                        <Tooltip title={`未添加对账客户/项目为合作伙伴，请在${window.globalConfig.title} APP 中添加`}>
                        <span style={{fontSize: 'smaller', color: '#3d3c3c', userSelect: 'none', cursor: 'pointer'}}>
                        <QuestionCircleOutlined style={{marginRight: 5}}/>找不到对账客户/项目？
                    </span>
                        </Tooltip>
                    </p>
                    <p style={{
                    ...
                    <Button type="primary" style={{color: '#fff', marginBottom: 20}} onClick={() => {
                        this.setState({isSelectGoodsModalVisible: true});
                    }}><PlusOutlined/>添加物资</Button>
                    {
