...
import Step1Lessee from "../../Components/Step1Lessee";
import Step2Lessee from "../../Components/Step2Lessee";
 ...
 * 承租方创建合同
 */
class LesseeContractCreate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            currentStep: 0,
    ...
    render() {
        return (
            <ViewCoat
                breadCrumb={[{title: "合同助手"}, {title: "承租方创建租赁合同"},]}
            >
                                ...
                                return <Step4
                                    ...
                                    onSubmit={() => {
                                        ...
                                        request(Api.ContractLessorAdd, {
                                            lesseeSn: this.state.data.lessorSn,//	string	是	出租方用户编号
                ...
                <Button onClick={() => {
                    ...
                    request(Api.ContractLesseeAdd, {
                        lessorSn: this.state.data.lessorSn,//	string	是	出租
                        projectSn: this.state.data.projectSn,
                        skuList: skuList,//	arr-object	是	sku列表
                        feeType: this.state.data.feeType, // 计费方式(1.按月计费2. 按天计费）
                        settlementDate: this.state.data.settlementDate, // 租赁业务周期（结算日期1-28号）
                        ...
                        message.info("提交成功");
                        this.props.history.push("/pages/appCenter/contractAsst/contractAsstHome/contractInfoMaintainIndex");
                    }, () => {
                    });
                }}>临时提交测试</Button>
            </ViewCoat>
...
export default LesseeContractCreate;
