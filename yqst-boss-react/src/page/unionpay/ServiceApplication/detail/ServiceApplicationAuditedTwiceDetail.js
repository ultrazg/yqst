...
class ServiceApplicationAuditedTwiceDetails extends Component {
    ...
    render() {
        const {data, LogList, appealDeal} = this.state
        const {
            appealUserVO,
            appealManageVO,
            appealServiceVO,
            ...
            <ViewContent crumb={crumb}>
                                    ...
                                    <Col span={24}>
                                        <Col span={24}>
                                            {headerList([
                                                ...
                                                {title: '商户销售方式', value: {5:'实地交易', 6:'网上交易', 7:'电购',8:'邮购', 9:'其他'}[appealUserVO.saleWay]},
                                                {title: '商户性质',value:{11:'公司制', 12:'合伙企业', 13:'个体工商户',14:'事业单位/社会团体', 15:'其他'}[appealUserVO.nature]},
                                    ...
                                    <Col span={24}>
                                        <Col span={24}>
                                            {headerList([
                                                ...
                                                {title: '经营地段', value:{20:'商业区',21:'工业区',22:'住宅区'}[appealManageVO.area]},
                                                {
                                                    title: '营业时间',
                                                    value:
                                                        <span>{appealManageVO.beginTime}至{appealManageVO.endTime}</span>
                                                },
                                                {title: '商户属性', value:{28:'对公商户',29:'个体商户'}[appealManageVO.attribute]},
                                                ...
                                                {title: '经营区域', value:{24:'城区', 25:'郊区', 26:'边远地区'}[appealManageVO.region]},
                ...
                </Row>
                {
                    appealDeal.isShow ? <Modal
                        ...
                        footer={<span>
                                   ...
                                   <Button type='primary' onClick={() => {
                                       ...
                                       if (submit.memo.length > 15) {
                                           return message.warning('驳回理由不超过15个字')
                                       }
                                       obj = {
                                           ...(appealDeal.submit),
                                           ...submit,
                    ...
                    >
                        ...
                        <FormItem {...formItemLayout} label="审核驳回理由">
                            {getFieldDecorator('memo')(<TextArea placeholder='请输入不超过15个字'/>)}
                        </FormItem>
...
const ServiceApplicationAuditedTwiceDetail = Form.create()(ServiceApplicationAuditedTwiceDetails)
export default ServiceApplicationAuditedTwiceDetail
