...
import CostAssistantMenu from './CostAssistantMenu';
import CostAssistantRouter from './CostAssistantRouter';
import './CostAssistantLess.less';
import {LeftOutlined} from '@ant-design/icons'

const {SubMenu} = Menu;

class CostAssistantHome extends Component {
    constructor(props) {
        super(props);
        this.state = {
            openKeys: [],
...
export default CostAssistantHome;
