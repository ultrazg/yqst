...
import {Button, Divider, message, Collapse, InputNumber, Popconfirm} from "antd";
 ...
 * 切割赔偿
 */
class Step2Lessor extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isSelectAfterGoodsVisi: false,
            isSelectBeforeGoodsVisi: false,
        };
    }
