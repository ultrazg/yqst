 ...
 * 查看本期业务单据modal
 */
class OriginalBillModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    getList = () => {
        CostAssistantModel.CostAsstSettlementOriginalBillListPreview(this.state.requestPar, res => {
            this.setState({
...
export default OriginalBillModal;