...
class SaProductList extends Component {
        ...
        if (id && id !== '') {
            ...
            Model.sellerGoodsAdd(this.state.submitData, res => {
                ...
                if (goback === true) {
                    ...
                    this.props.history.replace(`/pages/appCenter/productLib/saProductHome/saProModule/saProductDetail?id=${res.data}&operation=edit`)
                }
            })
        }
    }
    ...
    enable() {
        const {id, operation} = getPageQuery()
        Model.sellerGoodsEnable({goodsSn: id}, () => {
            this.getDetail();
        }, () => {
        })
    }
                ...
                topView={(
                    <div>
                        ...
                        {id && id !== '' && <Button
                            ...
                            onClick={() => this.enable()}
                            disabled={this.state.detailLoading || this.state.submitData.status == 2}
                        >
                            {this.state.submitData.status == 2 ? "已启用" : "启用"}
                        </Button>}
                    </div>
                )}
            >
            ...
            return (
                ...
                >
                    <div style={{display: 'flex', alignItems: 'center', marginBottom: 16}}>
                        <label style={{width: '15%', textAlign: 'right'}}>产品价格:</label>
                        <InputNumber
                            min={0}
                            precision={2}
                            max={9999999.99}
                    ...
                    <div style={{display: 'flex', alignItems: 'center', marginBottom: 16}}>
                        ...
                        <InputNumber
                            ...
                            onChange={value => {
                                this.setState({
                                        billData: {...this.state.billData, convertRatio: value}
                                    }
                                )
                            }}
                        />
        ...
        return (
            ...
            >
                ...
                <Row gutter={12}>
                    ...
                    {/*<Col span={24} style={{marginBottom: 24}}>*/}
                    {/*    <Col span={3}>*/}
                    {/*        <label className={'sw-form-label'}>换算比例:</label>*/}
                    {/*    </Col>*/}
                    {/*    <Col span={6}>*/}
                    {/*        <InputNumber*/}
                    {/*            min={0}*/}
                    {/*            precision={4}*/}
                    {/*            max={9999999.9999}*/}
                    {/*            value={this.state.submitData.convertRatio}*/}
                    {/*            onChange={(value) => {*/}
                    {/*                this.setState({*/}
                    {/*                    submitData: {...this.state.submitData, convertRatio: value}*/}
                    {/*                })*/}
                    {/*            }}*/}
                    {/*            style={{borderRadius: 0}}*/}
                    {/*        />*/}
