...
//单个文件下载
    ...
    window.getOrginUrl = (src) => {
        console.log((window.downLoadHost ? window.downLoadHost + "?url=" : "") + src);
        return (window.downLoadHost ? window.downLoadHost + "?url=" : "") + src;
    };
