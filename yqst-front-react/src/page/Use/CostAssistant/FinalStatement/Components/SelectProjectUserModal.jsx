 ...
 * 选择项目
 */
class SelectProjectUserModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    getList = () => {
        CostAssistantModel.CostAsstGetSettlementProjectUserList(this.state.requestPar, res => {
            this.setState({
...
export default SelectProjectUserModal;