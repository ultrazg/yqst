...
class ServiceApplicationContractAccepteds extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: {
            ...
            DictionaryList: [{value: 11, name: '公司制'}, {value: 12, name: '合伙企业'}, {
                value: 13,
                name: '个体工商户'
            }, {value: 14, name: '事业单位/社会团体'}, {value: 15, name: '其他'},]
        }
    }
            ...
            },
            {
                ...
                render: (a, b, c) => {
                    return <Button size='small' type='primary'
                                   onClick={() => {
                                       return this.props.history.push(`/Pages/ServiceApplicationContractAcceptedDetail?id=${b.appealId}`)
                                   }}>操作</Button>
                }
            }]
        return (
...
const ServiceApplicationContractAccepted = ServiceApplicationContractAccepteds
export default ServiceApplicationContractAccepted
