...
class ServiceApplicationDepositReceivedDetails extends Component {
                                        ...
                                        Modal.info({
                                            ...
                                            content: (
                                                <Row>
                                                    ...
                                                    <Col span={24}>
                                                        <Steps direction="vertical" current={obj.result.list.length - 1}
                                                               style={{maxHeight: 300, overflow: 'auto'}}>
                                                            {
                                                                (obj.result.list.reverse()).map((v, k) => {
                                                                    return <Step key={k} title={v.status}
                                                                                 description={v.time}/>
                                                                })
                                                            }
                                                        </Steps>
...
const ServiceApplicationDepositReceivedDetail = Form.create()(ServiceApplicationDepositReceivedDetails)
export default ServiceApplicationDepositReceivedDetail
