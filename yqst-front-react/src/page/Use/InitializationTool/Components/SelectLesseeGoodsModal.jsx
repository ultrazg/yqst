...
import {Button, Input, Modal, Checkbox, Collapse, Empty, Pagination} from "antd";
 ...
 * 承租方选择物资
 */
class SelectLesseeGoodsModal extends Component {
    constructor(props) {
        super(props);
    ...
    getList() {
        Model.LesseeGoodsPage(this.state.requestPar, res => {
            this.setState({
...
export default SelectLesseeGoodsModal;