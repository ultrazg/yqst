            ...
            <Modal
                ...
                onOk={() => {
                    model.softGroupUserSoftSave({groupSaveMessage: JSON.stringify(this.state.currentEditItem)}, res => {
                        ...
                        this.setState({currentEditItem: {}, editNameVisible: false})
                        this.getList()
                    })
                }}
            >
                <label>分组名称:</label> : <Input onChange={(e) => {
...

                                    {
                                        isSet && setIndex === index ?
                                            <a
                                                ...
                                                onClick={() => this.setState({isSet: false})}
                                            >
                                                取消
                                            </a> : null
                                    }
                                                    ...
                                                    isAdmin && !isSet ? <Dropdown
                                                        ...
                                                        overlay={<div>
                                                            <Button
                                                                ...
                                                                onClick={() => {
                                                                    this.props.history.push(`/pages/appCenter/applySetUp?serviceTag=${item.serviceTag}`);
                                                                }}
                                                            >设置</Button>
                                                        </div>}
                                                    >
